...
public class YxcxAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<Yxcx> mData;

	public YxcxAdapter(Context context, ArrayList<Yxcx> datas) {
		mContext = context;
		mData = datas;
	}
