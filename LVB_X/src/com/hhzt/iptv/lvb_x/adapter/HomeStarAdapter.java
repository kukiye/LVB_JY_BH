 ...
 */
public class HomeStarAdapter extends RecyclerView.Adapter<HomeStarAdapter.ViewHolder> {
    ...
    private OnLeftEdgeListener leftEdgeListener;
    ...
    public void setOnLeftEdgeListener(HomeStarAdapter.OnLeftEdgeListener leftEdgeListener) {
        this.leftEdgeListener = leftEdgeListener;
    }


    public HomeStarAdapter(Activity context, RecyclerView recyleview, List<VodDetailItemModel> liststr) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout item__view_container;
        Button item_btn;
        ...
        public ViewHolder(View view) {
            ...
            item__view_container = (LinearLayout) view.findViewById(R.id.item_layout);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.home_star_layout, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (drawable == null) {
            holder.item_image.setBackgroundResource(R.drawable.star_default);
        }
                    ...
                    case KeyEvent.KEYCODE_DPAD_LEFT:
                        if (keyEvent.getAction() == KeyEvent.ACTION_UP) {
                            ...
                            if (holder.getAdapterPosition() == 0) {
                                if (leftEdgeListener != null) {
                                    leftEdgeListener.onLeftEdge();
                                }
