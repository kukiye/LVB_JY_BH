...
public class DzcxAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<Dzcx> mData;

	public DzcxAdapter(Context context, ArrayList<Dzcx> datas) {
		mContext = context;
		mData = datas;
	}
	...
	private void setValue(Holder holder, int position) {
		...
		holder.item5.setText(model.getSzzh());
		holder.item6.setText(model.getZhye());
		holder.item7.setText(model.getByxf());
		holder.item8.setText(model.getKyye());
		holder.item9.setText(DateTimeUtil.toTime(model.getDate(),
