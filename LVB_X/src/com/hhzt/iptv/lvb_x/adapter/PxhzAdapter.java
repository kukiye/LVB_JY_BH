...
public class PxhzAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<Pxhz> mData;

	public PxhzAdapter(Context context, ArrayList<Pxhz> datas) {
		mContext = context;
		mData = datas;
	}
