...
public class XzjcAdapter extends BaseAdapter {

	private Context mContext;
	private ArrayList<Xzjc> mData;

	public XzjcAdapter(Context context, ArrayList<Xzjc> datas) {
		mContext = context;
		mData = datas;
	}
	...
	private void setValue(Holder holder, int position) {
		...
		holder.item5.setText(model.getDetail());
