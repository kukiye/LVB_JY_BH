 ...
 */
public class MainStarAdapter extends RecyclerView.Adapter<MainStarAdapter.ViewHolder> {
    ...
    public void setOnLeftEdgeListener(OnLeftEdgeListener leftEdgeListener) {
        this.leftEdgeListener = leftEdgeListener;
    }


    public MainStarAdapter(Activity context, RecyclerView recyleview, List<VodDetailItemModel> liststr) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.main_star_layout, parent, false);
