...
public class PrisonWebsitListAdapter extends BaseAdapter {

	private Context mContext;
	private List<PrisonWebsitCategoryModel> mList;

	public void setmContext(Context mContext) {
		this.mContext = mContext;
	}

	public void setmList(List<PrisonWebsitCategoryModel> mList) {
		this.mList = mList;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.typeName.setText(mList.get(position).getName());
		return convertView;
	}
}
