...
public class FoodAdapter extends BaseAdapter {
	...
	public FoodAdapter(Context context, List<FoodModel> datas) {
		mContext = context;
		mData = datas;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (null == arg1) {
			holder = new Holder();
			arg1 = LayoutInflater.from(mContext).inflate(R.layout.sub_food_item, null);
	...
	private void setValue(Holder holder, int position) {
		...
		holder.item1.setText(DateTimeUtil.toTime(model.getDate(),
				DateTimeUtil.DATE_FORMATE_YEAR_MONTH_DAY));
		holder.item2.setText(model.getWeek());
		holder.item3.setText(model.getBreakfastStaple());
		holder.item4.setText(model.getBreakfastSupplement());
		holder.item5.setText(model.getLunchStaple());
		holder.item6.setText(model.getLunchSupplement());
		holder.item7.setText(model.getDinnerStaple());
		holder.item8.setText(model.getDinnerSupplement());
	}
