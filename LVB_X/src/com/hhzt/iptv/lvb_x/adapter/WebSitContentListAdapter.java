...
public class WebSitContentListAdapter extends BaseAdapter {

	private Context mContext;
	private List<PrsionWebsitModel> mList;

	public void setmContext(Context mContext) {
		this.mContext = mContext;
	}

	public void setmList(List<PrsionWebsitModel> mList) {
		this.mList = mList;
	...
	private void setValue(VodTypeHolder holder, int position) {
		PrsionWebsitModel model = mList.get(position);
		holder.news_title.setText(model.getTitle());
		holder.news_time.setText(DateTimeUtil.toTime(model.getTime(), DateTimeUtil.DATE_FORMATE_YEAR_MONTH_DAY));
	}
}
