...
@RemoteView
public class AnalogClockLondon extends View {
	 ...
	 * 构造方法
	 */
	public AnalogClockLondon(Context context) {
		this(context, null);
	}

	public AnalogClockLondon(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AnalogClockLondon(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		/**
		 * 初始化日历对象
		 */
		mCalendar = new Time(TimeZoneType.timeZoneLondon);
