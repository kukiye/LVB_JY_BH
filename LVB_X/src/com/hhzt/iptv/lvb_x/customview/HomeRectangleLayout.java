...
public class HomeRectangleLayout extends LinearLayout {
    ...
    private VodTypeItemModel model;


    public HomeRectangleLayout(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public HomeRectangleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.home_rectangle_layout, this, true);
    ...
    public void setModel(VodTypeItemModel vodTypeItemModel) {
        this.model = vodTypeItemModel;
        setNetImage(vodTypeItemModel.getTypeimage(), vodTypeItemModel.getCategoryname());
    }
