...
@RemoteView
public class AnalogClockNewYork extends View {
	 ...
	 * 构造方法
	 */
	public AnalogClockNewYork(Context context) {
		this(context, null);
	}

	public AnalogClockNewYork(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AnalogClockNewYork(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		/**
		 * 初始化日历对象
		 */
		mCalendar = new Time(TimeZoneType.timeZoneNewYork);
