...
public class HeartGuidanceFragment extends BaseLazyFragment implements View.OnKeyListener {
    ...
    protected View initView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_heart_guide, container,
                false);
    ...
    protected void onVisible() {
        ...
        UIDataller.getDataller().setVodTypeData(mActivity, model.getCode(), new IVodTypeListSuccessed() {
            ...
            public void onTypeListSuccess(ArrayList<VodTypeItemModel> models) {
                ...
                sendHandlerMessage(mHandler, HandlerValue.REQ_HOME_PRISON_HEART, 0, models);
    ...
    public void dispatchMessage(Message msg) {
        ...
        switch (msg.what) {
            case HandlerValue.REQ_HOME_PRISON_HEART:
                //左侧广告位  注意 很有可能有变化
    ...
    private void showVodDetailView() {
        ...
        transaction.replace(R.id.heart_content_layout, videoGrideFragment);
        transaction.commit();
