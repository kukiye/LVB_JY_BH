...
import com.hhzt.iptv.lvb_x.fragments.PrisonInfoFragment;
import com.hhzt.iptv.lvb_x.mgr.FragmentMgr;
import com.lidroid.xutils.view.annotation.ContentView;

@ContentView(R.layout.activity_base)
public class PrisonInfoActivity extends BaseActivity {

	private PrisonInfoFragment mFragment;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		mFragment = new PrisonInfoFragment();
