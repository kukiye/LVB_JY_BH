/**
 * 作者：   Johnson
 * 日期：   2014年6月25日下午6:16:24
 * 包名：    com.hhzt.iptv.lvb_x.controller
 * 工程名：LVB_X
 * 文件名：HSSubHotelActivity.java
 */
...
public class HSSubHotelActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FragmentMgr.replace(this, false, R.id.fragment_container, mFragment, Constant.HOTEL_SUBHS_INTRODUCE_SCREEN);
	}
